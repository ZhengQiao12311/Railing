...
tStart = tic;  
lasReader = lasFileReader('Railing1_high_044.las');%check the correct file
PtCloud_railing = readPointCloud(lasReader);
%imput parameter
resolution = 0.002;
x_scanner = 0;
y_scanner = 0;
z_scanner = 93.007242;% from scene scanner position
...
filenumber = 2;%high resolustion 2，median resolution 3，low resolustion 4
