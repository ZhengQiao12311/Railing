...
tStart = tic;  
lasReader = lasFileReader('Railing1_low_046.las');%check the correct file
PtCloud_railing = readPointCloud(lasReader);
%imput parameter
resolution = 0.005;
x_scanner = 0;
y_scanner = 0;
z_scanner = 93.8753;% from scene scanner position
...
filenumber = 4;%high resolustion 2，median resolution 3，low resolustion 4
